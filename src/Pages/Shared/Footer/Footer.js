...
const Footer = () => {
    return (
        <footer className="footer px-10 py-2 bg-zinc-900 text-white mt-10">
            <div>
                <a href="/"><img style={{ width: '20px' }} src={logo} alt="" /></a>
                <p className="footer-title">Used Buyer<br />Reliable portal for buying and selling  old phone </p>
            </div>
            <div>
